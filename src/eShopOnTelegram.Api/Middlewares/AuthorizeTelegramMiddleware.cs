...
using eShopOnTelegram.Api.Attributes;

namespace eShopOnTelegram.Api.Middlewares;
    ...
    public async Task InvokeAsync(HttpContext context, IConfiguration configuration)
    {
        ...
        if (authorizeTelegramAttribute != null)
        {
            ...
            try
            {
                ...
                var telegramBotToken = configuration["Telegram:Token"];
...
public static class ValidateCaptchaMiddlewareExtensions
{
    public static IApplicationBuilder UseTelegramAuthorization(
