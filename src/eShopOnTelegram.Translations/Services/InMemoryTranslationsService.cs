	...
	{
		{
			...
			new()
			{
				...
				{ TranslationsKeys.PayWithCrypto, "Pay with crypto" },
				{ TranslationsKeys.OrderAlreadyHasBeenPaid, "You already paid for this order. Create new order if you want new item" },
				{ TranslationsKeys.TimeToPayForOrderExpired, "Time to pay for order expired. Please, create new order" },
		...
		},
		{
			...
			new ()
			{
				...
				{ TranslationsKeys.PayWithCrypto, "Оплата криптовалютой" },
				{ TranslationsKeys.OrderAlreadyHasBeenPaid, "Заказ уже был оплачен. Перейдите в магазин, чтобы создать новый заказ" },
				{ TranslationsKeys.TimeToPayForOrderExpired, "Время для подтверждения оплаты прошло. Пожалуйста, перейдите в магазин, чтобы создать новый заказ" },
